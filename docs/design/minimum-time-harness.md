...
| MODIFY | `README.md` | Document minimum time harness usage |
| MODIFY | `skills/vidbyte-sdk/SKILL.md` | Update SDK structure guidance for time harnesses and required tools |
| MODIFY | `vidbyte/__init__.py` | Export public time harness and tool contracts where appropriate |
| MODIFY | `vidbyte/client.py` | Preserve root SDK construction and imports after harness additions |
| MODIFY | `vidbyte/harnesses/__init__.py` | Export time harness package classes |
| MODIFY | `vidbyte/harnesses/client.py` | Add `minimum_time` discoverability property |
| MODIFY | `vidbyte/tools/__init__.py` | Export minimal tool base and spec |
| MODIFY | `vidbyte/lib/errors/__init__.py` | Export SDK error hierarchy |
| CREATE | `vidbyte/lib/errors/base.py` | SDK exception classes |
| CREATE | `vidbyte/tools/types.py` | `ToolSpec` metadata dataclass |
| CREATE | `vidbyte/tools/base.py` | Minimal `BaseTool` contract |
| CREATE | `vidbyte/tools/builtins/__init__.py` | Built-in tool contract exports |
| CREATE | `vidbyte/tools/builtins/time.py` | `BaseDateTool` and `SystemDateTool` |
| CREATE | `vidbyte/tools/builtins/compaction.py` | `BaseCompactionTool` |
| CREATE | `vidbyte/harnesses/time/__init__.py` | Time harness exports |
| CREATE | `vidbyte/harnesses/time/types.py` | Time harness config, state, result, and status types |
...
Summary: 11 files created, 8 files modified, 0 files deleted.
