...
class SkillsInterfaceTests(unittest.TestCase):
    def test_get_accepts_skill_enum_and_returns_record(self) -> None:
        ...
        self.assertEqual(record.key, ContextMinimalFanoutSkill.DECOMPOSE_FANOUT)
    ...
    def test_keys_and_descriptions_are_enum_keyed(self) -> None:
        ...
        self.assertEqual(SkillEnums["context_minimal_fanout"], ContextMinimalFanoutSkill)
        self.assertEqual(set(skills.keys()), set(ContextMinimalFanoutSkill))
        self.assertEqual(set(skills.descriptions()), set(ContextMinimalFanoutSkill))
    ...
    def test_paradigm_returns_family_records(self) -> None:
        ...
        self.assertEqual(set(family), set(ContextMinimalFanoutSkill))
    ...
    def test_files_include_frontmatter_for_every_skill(self) -> None:
        ...
        for key in skills.keys():
            ...
            self.assertIn("## Description", record.text)
            self.assertNotIn("## Use Cases", record.text)
    ...
    def test_fanout_files_include_shared_references(self) -> None:
        ...
        for key in (
            ContextMinimalFanoutSkill.DECOMPOSE_DESIGN_FANOUT,
    ...
    def test_materialize_writes_skill_folder_and_references(self) -> None:
        ...
        with tempfile.TemporaryDirectory() as tmp_dir:
            target = Skills().materialize(ContextMinimalFanoutSkill.DECOMPOSE_FANOUT, tmp_dir)
            root = Path(tmp_dir)
