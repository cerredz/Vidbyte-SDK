...
trajectory_checkpoint_injection  # one checkpoint primitive written into ContextManager
```
...
configured cadence and `max_checkpoints` cap allow a checkpoint primitive to be
written into the active `ContextManager`.
