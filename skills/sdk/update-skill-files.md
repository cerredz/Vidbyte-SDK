...
**Example:** Creating `vidbyte/strategies/reasoning/graph_of_thought.py` with `GraphOfThoughtStrategy`.

**Files to update:**

| File | What to add |
|------|-------------|
| `skills/usage/available_features.md` | Add to the appropriate Strategies subsection (Reasoning, Sampling, Agent Loop, Routing) with import and description |
| `skills/sdk/SKILL.md` | Update Framework Boundaries if it introduces a new strategy category; update Current Layout if new file path |

### Add a New Multi-Agent Strategy

**Example:** Creating `vidbyte/strategies/multi_agent/debate.py` with `DebateStrategy`.

**Files to update:**

| File | What to add |
|------|-------------|
| `skills/usage/available_features.md` | Add to Multi-Agent Strategies section with import and description |
| `skills/usage/create_agents.md` | Add to "Multi-Agent with Strategies" section with usage example |
| `skills/sdk/SKILL.md` | Update Framework Boundaries table if introducing a new concept |
...
| File | What to add |
|------|-------------|
| `skills/usage/import_prompt.md` | Add to Available Prompt Families table; add enum members to complete listing; add direct imports to Direct String Imports section |
| `skills/vidbyte-sdk/adding-prompts.md` | (This doc is the process reference; confirm the steps are still accurate) |
| `skills/sdk/SKILL.md` | Update the prompt families count in Core Use Cases |
...
| File | What to add |
|------|-------------|
| `skills/usage/available_features.md` | Add to Middleware section with name, description, and code example |
| `skills/sdk/SKILL.md` | Add to the Built-in Middleware paragraph in the Middleware section |
...
- [ ] All constructor signatures match the current `Agent.__init__` parameter list
- [ ] All provider names match the current `ModelProvider` enum
- [ ] All tool names match the current tool files
- [ ] The Usage Skill Files table in `skills/sdk/SKILL.md` lists all usage files
- [ ] The SDK Developer Reference table in `skills/sdk/SKILL.md` lists all reference docs
