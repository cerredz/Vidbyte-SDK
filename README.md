...
| [`vidbyte.paradigms`](vidbyte/paradigms/README.md) | Thin runnable paradigm harnesses built from agents, tools, context, prompts, middleware, trace, pipelines, and evals |
