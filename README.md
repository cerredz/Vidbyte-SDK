...
| [`vidbyte.integrations`](vidbyte/integrations/README.md) | `Sources`: external provider resources compiled into agent context items, resource-scoped tools, and a scope permission policy |
