"""FILE: lint/rules/s028_bandit_security_subset.py

PURPOSE: Defines S028 as one independently ratcheted Ruff-backed SDK security policy.
...
class BanditSecuritySubsetRule(RuffBackedRule):
    ...
    summary = "Source avoids unsafe YAML loading, pickle/marshal deserialization, weak hashes, disabled TLS verification, hardcoded credential-shaped literals, and predictable temp paths."
    codes = frozenset({"S105", "S106", "S107", "S108", "S301", "S302", "S324", "S501", "S506"})
