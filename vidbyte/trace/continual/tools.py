...
Relations:
    Used by vidbyte.trace.continual.agent.ContinualTraceAgent. Depends on the public
...
class UpdateTraceTool(BaseTool):
    ...
    def spec(self) -> ToolSpec:
        ...
        return ToolSpec(
            ...
            description="Update the continual trace artifact with new information found in the main agent context.",
            parameters=(
                ToolParameter(
                    name="trace",
                    type="object",
                    description="A partial or complete trace artifact object using only the declared schema fields.",
                    required=True,
                ),
            ),
    ...
    def _input_schema(self) -> dict[str, Any]:
        ...
        return {
            ...
            "properties": {
                "trace": {
                    "type": "object",
                    "description": "Trace artifact update; only declared schema fields are accepted.",
