...
TESTS: tests/test_jev_agent.py, tests/test_jev_alignment.py, and scripts/test-jev-agent-scaffold.py.
"""
...
class JevRuntime(AgentRuntime):
    ...
    async def arun(
        ...
        *,
        ...
        """Align the system prompt for this request when enabled, then run the inherited loop."""
        ...
        aligned, context = await self._align(alignment, message, context)
        ...
        return replace(result, metadata={**dict(result.metadata), ALIGNMENT_METADATA_KEY: aligned})
