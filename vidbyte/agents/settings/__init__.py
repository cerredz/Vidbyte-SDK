...
PURPOSE:
    Public exports for the vidbyte.agents.settings sub-package. Exposes AgentLoopSettings and nested settings objects for agentic loop parameters.
...
FILE DEPENDENCIES:
    - vidbyte.agents.settings.loop: imported by this file.
