...
PURPOSE:
    Implements Point-to-Point and Broadcast multi-agent brokers. Orchestrates actor loops, concurrent task lifecycles, structured message passing, and fail-fast termination gates in multi-agent executions.
...
FUNCTION INVENTORY:
    - BaseActorRuntime (class): public or navigational symbol owned here.
    - PointToPointActorRuntime (class): public or navigational symbol owned here.
    - BroadcastActorRuntime (class): public or navigational symbol owned here.
