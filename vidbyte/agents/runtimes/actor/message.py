"""
FILE: vidbyte/agents/runtimes/actor/message.py

PURPOSE:
    Defines the structured ActorMessage class for message passing between concurrent actors. Enables reliable context, state, and conversation propagation across concurrent actors in both Point-to-Point and Broadcast topologies.
...
FUNCTION INVENTORY:
    - ActorMessage (class): public or navigational symbol owned here.
