"""
FILE: vidbyte/agents/runtimes/actor/inbox.py

PURPOSE:
    Implements a thread-safe asynchronous message queue for individual agent actors. Provides decoupled communication in concurrent agent actor systems, serving as the primary polling/waiting state for active worker tasks.
...
FUNCTION INVENTORY:
    - ActorInbox (class): public or navigational symbol owned here.
