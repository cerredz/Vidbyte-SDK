...
Architecture:
    ...
    - PairwiseTournamentRuntimeAlgorithm: Executes isolated knockout selection.
Relations:
...
from vidbyte.agents.algorithms.pairwise_tournament import PairwiseTournamentRuntimeAlgorithm
