...
PURPOSE:
    Defines mixins that equip agents and harnesses with lifecycle-managed and preset MCP servers. Enforces identical APIs and automated cleanup routines for attached subprocesses without duplicating logic across agents and harnesses.
...
FILE DEPENDENCIES:
    ...
    - vidbyte.tools.mcp.attach: imported by this file.
    - vidbyte.tools.mcp.presets: imported by this file.
    - vidbyte.tools.mcp.types: imported by this file.

FUNCTION INVENTORY:
    - McpAttachableMixin (class): public or navigational symbol owned here.
...
COMMON ERRORS RAISED BY THIS FILE:
    - McpAttachmentError: raised, returned, or imported by this file. Keep context safe and grepable.
