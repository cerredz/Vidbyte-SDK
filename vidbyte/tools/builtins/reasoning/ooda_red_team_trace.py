...
FILE: vidbyte/tools/builtins/reasoning/ooda_red_team_trace.py
PURPOSE: Defines the ooda-red-team-trace model-facing reasoning trace tool and its immutable strategy definition.
...
Description:
    Defines the ooda-red-team-trace strategy-specific reasoning trace tool.
Purpose:
...
Architecture:
    - OodaRedTeamTraceTool: Strategy-owned description and parameter shape.
