...
FILE: vidbyte/tools/builtins/reasoning/leverage_points_trace.py
PURPOSE: Defines the leverage-points-trace model-facing reasoning trace tool and its immutable strategy definition.
