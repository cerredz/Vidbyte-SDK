...
FILE: vidbyte/tools/builtins/reasoning/swot_trace.py
PURPOSE: Defines the swot-trace model-facing reasoning trace tool and its immutable strategy definition.
