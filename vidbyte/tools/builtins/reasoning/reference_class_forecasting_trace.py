...
FILE: vidbyte/tools/builtins/reasoning/reference_class_forecasting_trace.py
PURPOSE: Defines the reference-class-forecasting-trace model-facing reasoning trace tool and its immutable strategy definition.
