...
FILE: vidbyte/tools/builtins/reasoning/uncertainty_quantification_trace.py
PURPOSE: Defines the uncertainty-quantification-trace model-facing reasoning trace tool and its immutable strategy definition.
