...
FILE: vidbyte/tools/builtins/reasoning/morphological_analysis_trace.py
PURPOSE: Defines the morphological-analysis-trace model-facing reasoning trace tool and its immutable strategy definition.
