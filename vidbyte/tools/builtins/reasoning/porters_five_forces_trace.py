...
FILE: vidbyte/tools/builtins/reasoning/porters_five_forces_trace.py
PURPOSE: Defines the porters-five-forces-trace model-facing reasoning trace tool and its immutable strategy definition.
