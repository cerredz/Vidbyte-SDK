...
FILE: vidbyte/tools/builtins/reasoning/event_tree_trace.py
PURPOSE: Defines the event-tree-trace model-facing reasoning trace tool and its immutable strategy definition.
