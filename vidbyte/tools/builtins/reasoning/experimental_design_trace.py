...
FILE: vidbyte/tools/builtins/reasoning/experimental_design_trace.py
PURPOSE: Defines the experimental-design-trace model-facing reasoning trace tool and its immutable strategy definition.
...
Description:
    Defines the experimental-design-trace strategy-specific reasoning trace tool.
Purpose:
...
Architecture:
    - ExperimentalDesignTraceTool: Strategy-owned description and parameter shape.
...
class ExperimentalDesignTraceTool(ReasoningTraceTool):
    ...
    definition = ReasoningTraceDefinition(
        ...
        parameter(name='sample', type='string', description="Sample captures the observations selected to support the current inference for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        ...
        parameter(name='randomization', type='string', description="Randomization captures the randomization dimension of the strategy for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='metric', type='string', description="Metric captures the measurement used to distinguish outcomes for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='validity_risks', type='string', description="Validity risks captures the validity risks dimension of the strategy for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='confidence', type='number', description="Confidence captures the calibrated confidence in the current working direction for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='next_action', type='string', description="Next action captures the next observable action that will advance or test the work for the experimental design trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for define variables, controls, measures, randomization, and validity risks. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        ),
    )


__all__ = ['ExperimentalDesignTraceTool']
