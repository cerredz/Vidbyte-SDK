...
FILE: vidbyte/tools/builtins/reasoning/five_whys_trace.py
PURPOSE: Defines the five-whys-trace model-facing reasoning trace tool and its immutable strategy definition.
