...
FILE: vidbyte/tools/builtins/reasoning/value_chain_analysis_trace.py
PURPOSE: Defines the value-chain-analysis-trace model-facing reasoning trace tool and its immutable strategy definition.
