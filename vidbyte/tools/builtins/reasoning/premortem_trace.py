...
FILE: vidbyte/tools/builtins/reasoning/premortem_trace.py
PURPOSE: Defines the premortem-trace model-facing reasoning trace tool and its immutable strategy definition.
