...
FILE: vidbyte/tools/builtins/reasoning/balanced_scorecard_trace.py
PURPOSE: Defines the balanced-scorecard-trace model-facing reasoning trace tool and its immutable strategy definition.
