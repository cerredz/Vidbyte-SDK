...
FILE: vidbyte/tools/builtins/reasoning/null_hypothesis_trace.py
PURPOSE: Defines the null-hypothesis-trace model-facing reasoning trace tool and its immutable strategy definition.
...
Description:
    Defines the null-hypothesis-trace strategy-specific reasoning trace tool.
Purpose:
...
Architecture:
    - NullHypothesisTraceTool: Strategy-owned description and parameter shape.
...
class NullHypothesisTraceTool(ReasoningTraceTool):
    """Model-facing null-hypothesis-trace reasoning trace tool."""

    definition = ReasoningTraceDefinition(
        skill_name='null-hypothesis-trace',
        purpose='Test whether evidence justifies rejecting no effect or no difference.',
        description='Use the null hypothesis reasoning trace when the current task benefits from test whether evidence justifies rejecting no effect or no difference. Its central move gives the public checkpoint a strategy-specific structure for examining the question. The parameters separate the observations, judgments, uncertainties, and actions that make the strategy inspectable. The tool writes one bounded context primitive so later iterations can recover the declared reasoning state. Use it at a meaningful checkpoint after the relevant inputs are available and before the next action is chosen. The record does not execute the strategy, verify model-authored claims, or replace authoritative task instructions. Treat the result as auditable telemetry that supports comparison across iterations without exposing private chain-of-thought.',
        parameters=(
        parameter(name='question', type='string', description="Question captures the focused question or decision target for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='null_hypothesis', type='string', description="Null hypothesis captures the null hypothesis dimension of the strategy for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='alternative_hypothesis', type='string', description="Alternative hypothesis captures the alternative hypothesis dimension of the strategy for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='test', type='string', description="Test captures the observation or procedure that could distinguish the leading accounts for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='sample', type='string', description="Sample captures the observations selected to support the current inference for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='threshold', type='string', description="Threshold captures the threshold dimension of the strategy for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='result', type='string', description="Result captures the measured outcome produced by the current method for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='confidence', type='number', description="Confidence captures the calibrated confidence in the current working direction for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='next_action', type='string', description="Next action captures the next observable action that will advance or test the work for the null hypothesis trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for test whether evidence justifies rejecting no effect or no difference. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        ),
    )


__all__ = ['NullHypothesisTraceTool']
