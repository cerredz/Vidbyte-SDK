...
FILE: vidbyte/tools/builtins/reasoning/tradeoff_matrix_trace.py
PURPOSE: Defines the tradeoff-matrix-trace model-facing reasoning trace tool and its immutable strategy definition.
