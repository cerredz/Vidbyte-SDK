...
FILE: vidbyte/tools/builtins/reasoning/systems_thinking_trace.py
PURPOSE: Defines the systems-thinking-trace model-facing reasoning trace tool and its immutable strategy definition.
