...
FILE: vidbyte/tools/builtins/reasoning/bayesian_trace.py
PURPOSE: Defines the bayesian-trace model-facing reasoning trace tool and its immutable strategy definition.
