...
FILE: vidbyte/tools/builtins/reasoning/causal_loop_trace.py
PURPOSE: Defines the causal-loop-trace model-facing reasoning trace tool and its immutable strategy definition.
