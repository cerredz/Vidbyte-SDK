...
FILE: vidbyte/tools/builtins/reasoning/multi_attribute_utility_trace.py
PURPOSE: Defines the multi-attribute-utility-trace model-facing reasoning trace tool and its immutable strategy definition.
...
Description:
    Defines the multi-attribute-utility-trace strategy-specific reasoning trace tool.
Purpose:
...
Architecture:
    - MultiAttributeUtilityTraceTool: Strategy-owned description and parameter shape.
...
class MultiAttributeUtilityTraceTool(ReasoningTraceTool):
    """Model-facing multi-attribute-utility-trace reasoning trace tool."""

    definition = ReasoningTraceDefinition(
        skill_name='multi-attribute-utility-trace',
        purpose='Quantify preferences across conflicting objectives.',
        description='Use the multi attribute utility reasoning trace when the current task benefits from quantify preferences across conflicting objectives. Its central move gives the public checkpoint a strategy-specific structure for examining the question. The parameters separate the observations, judgments, uncertainties, and actions that make the strategy inspectable. The tool writes one bounded context primitive so later iterations can recover the declared reasoning state. Use it at a meaningful checkpoint after the relevant inputs are available and before the next action is chosen. The record does not execute the strategy, verify model-authored claims, or replace authoritative task instructions. Treat the result as auditable telemetry that supports comparison across iterations without exposing private chain-of-thought.',
        parameters=(
        parameter(name='question', type='string', description="Question captures the focused question or decision target for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='objectives', type='string', description="Objectives captures the objectives dimension of the strategy for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='attributes', type='string', description="Attributes captures the attributes dimension of the strategy for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='weights', type='number', description="Weights captures the relative importance assigned to the evaluation criteria for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='utilities', type='string', description="Utilities captures the utilities dimension of the strategy for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='uncertainty', type='string', description="Uncertainty captures the uncertainty dimension of the strategy for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='ranking', type='string', description="Ranking captures the ranking dimension of the strategy for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='confidence', type='number', description="Confidence captures the calibrated confidence in the current working direction for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        parameter(name='next_action', type='string', description="Next action captures the next observable action that will advance or test the work for the multi attribute utility trace. It keeps the record anchored to the strategy's central move rather than a generic account of reasoning. It separates this dimension from the other observations and judgments needed for quantify preferences across conflicting objectives. Record the material content that would change how a careful reviewer interprets the current state. Keep the value explicit enough that a later iteration can compare it with new evidence and revise it. Treat this field as model-authored telemetry whose usefulness depends on honest, bounded reporting."),
        ),
    )


__all__ = ['MultiAttributeUtilityTraceTool']
