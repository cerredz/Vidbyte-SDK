...
FILE: vidbyte/tools/builtins/reasoning/cynefin_trace.py
PURPOSE: Defines the cynefin-trace model-facing reasoning trace tool and its immutable strategy definition.
