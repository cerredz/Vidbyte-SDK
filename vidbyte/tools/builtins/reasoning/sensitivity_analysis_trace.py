...
FILE: vidbyte/tools/builtins/reasoning/sensitivity_analysis_trace.py
PURPOSE: Defines the sensitivity-analysis-trace model-facing reasoning trace tool and its immutable strategy definition.
