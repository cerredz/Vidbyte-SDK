...
PURPOSE:
    Adapts Python callables into Vidbyte ToolSpec, validation, and execution contracts.
...
FUNCTION INVENTORY:
    - FunctionTool (class): public or navigational symbol owned here.
...
COMMON ERRORS RAISED BY THIS FILE:
    ...
    - ValidationError: raised, returned, or imported by this file. Keep context safe and grepable.
