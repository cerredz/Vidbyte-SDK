...
_MODEL_NAME_MODALITY_MAP: dict[str, ModelModality] = {
    ...
    "gemini-3-flash-preview": ModelModality.TEXT,
    "gemini-3.1-pro-preview": ModelModality.TEXT,
    "gemini-3.1-flash-lite": ModelModality.TEXT,
    ...
    "grok-4": ModelModality.TEXT,
    "grok-4-fast-reasoning": ModelModality.TEXT,
    ...
    "deepseek-v4-flash": ModelModality.TEXT,
    "deepseek-v4-pro": ModelModality.TEXT,

    "glm-4": ModelModality.TEXT,
    "glm-4-flash": ModelModality.TEXT,
    "glm-4-plus": ModelModality.TEXT,
    "glm-4.6": ModelModality.TEXT,
    "glm-4.7": ModelModality.TEXT,
    "glm-4.7-flash": ModelModality.TEXT,
    "glm-4.7-flashx": ModelModality.TEXT,
    "glm-5-turbo": ModelModality.TEXT,
    "glm-5.1": ModelModality.TEXT,
    "glm-5.2": ModelModality.TEXT,

    "minimax-text-01": ModelModality.TEXT,
    "minimax-m2": ModelModality.TEXT,
    "minimax-m2.1": ModelModality.TEXT,
    "minimax-m2.5": ModelModality.TEXT,
    "minimax-m2.5-highspeed": ModelModality.TEXT,
    "minimax-m2.7": ModelModality.TEXT,
    "minimax-m2.7-highspeed": ModelModality.TEXT,
    "minimax-m3": ModelModality.TEXT,
    "MiniMax-M2": ModelModality.TEXT,
    "MiniMax-M2.1": ModelModality.TEXT,
    "MiniMax-M2.5": ModelModality.TEXT,
    "MiniMax-M2.5-highspeed": ModelModality.TEXT,
    ...
    "kimi-k2.7-code": ModelModality.TEXT,
    ...
    "nano-banana-2": ModelModality.IMAGE,
    ...
    "minimax-hailuo-02": ModelModality.VIDEO,
    ...
    "gemini-2.5-flash-tts-preview": ModelModality.AUDIO,
    "gemini-2.5-pro-tts-preview": ModelModality.AUDIO,
    ...
    "speech-2.8-hd": ModelModality.AUDIO,
    "speech-2.8-turbo": ModelModality.AUDIO,
    "speech-2.6-hd": ModelModality.AUDIO,
    "speech-2.6-turbo": ModelModality.AUDIO,
    ...
    "gemini-embedding-2": ModelModality.EMBEDDING,
    "gemini-embedding-2-preview": ModelModality.EMBEDDING,
