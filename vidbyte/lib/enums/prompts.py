...
Purpose:
    ...
    across 20 JSON/Markdown-backed families, including pairwise tournament judging.
...
class Prompt(str, Enum):
    ...
    PAIRWISE_TOURNAMENT_JUDGE_SYSTEM_PROMPT = "pairwise_tournament.judge_system_prompt"
    PAIRWISE_TOURNAMENT_JUDGE_PROMPT = "pairwise_tournament.judge_prompt"
