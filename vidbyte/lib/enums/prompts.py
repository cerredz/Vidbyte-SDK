...
Purpose:
    Enables static typing, autocomplete, and validation for static prompt templates
    across JSON/Markdown-backed families, including isolated critic and
    critique-adjudicate-revise role prompts.
