...
ROLE IN CODEBASE: `vidbyte/lib/dataclasses/jev.py` validates questions against these members, `vidbyte/providers/typesafe.py` serializes their values onto the wire, and `vidbyte/tools/classifier/jev_decide.py` derives its model-facing answer types from them.
