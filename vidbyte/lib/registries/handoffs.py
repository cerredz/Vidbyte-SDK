...
_DEFAULT_HANDOFFS: dict[str, type[Handoff]] = {
    ...
    "care_transition": CareTransitionHandoff,
    "diagnostic_workup": DiagnosticWorkupHandoff,
    "contract_review": ContractReviewHandoff,
    "legal_research": LegalResearchHandoff,
    "due_diligence": DueDiligenceHandoff,
    "ticket_escalation": TicketEscalationHandoff,
    "account_health": AccountHealthHandoff,
    "alert_triage": AlertTriageHandoff,
    "threat_hunt": ThreatHuntHandoff,
    "investment_thesis": InvestmentThesisHandoff,
    "deal": DealHandoff,
    "credit_analysis": CreditAnalysisHandoff,
    # Agent-native prebuilts.
    "context_window": ContextWindowHandoff,
    "tool_trajectory": ToolTrajectoryHandoff,
    "sub_agent_delegation": SubAgentDelegationHandoff,
    "orchestration": OrchestrationHandoff,
    "human_escalation": HumanEscalationHandoff,
    "checkpoint_resume": CheckpointResumeHandoff,
    "deep_research": DeepResearchHandoff,
    "retrieval": RetrievalHandoff,
    "browser_session": BrowserSessionHandoff,
    "computer_use": ComputerUseHandoff,
    "memory": MemoryHandoff,
    "verification": VerificationHandoff,
    "reasoning_trace": ReasoningTraceHandoff,
    "guardrail": GuardrailHandoff,
    "evaluation": EvaluationHandoff,
}
