...
OPERATION_PRICING: dict[tuple[str, str, str], OperationPricing] = {
    ...
    ("response", "parallel", "speed"): OperationPricing(usd_fixed=0.005),
    ("response", "parallel", "lite"): OperationPricing(usd_fixed=0.005),
    ("response", "parallel", "base"): OperationPricing(usd_fixed=0.010),
    ("response", "parallel", "core"): OperationPricing(usd_fixed=0.025),
