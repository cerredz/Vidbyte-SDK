...
ROLE IN CODEBASE: vidbyte/agents/jev imports these to validate settings and to build the one preflight Jev request; the gate that acts on Jev's answers is JevPreflight in vidbyte/agents/jev/preflight/.
