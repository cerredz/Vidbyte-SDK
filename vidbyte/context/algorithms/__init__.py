...
Architecture:
    ...
    - Specialist Panel public configuration from specialist_panel.
Relations:
...
from vidbyte.context.algorithms.specialist_panel import DEFAULT_SPECIALIST_ROLES, SpecialistPanelAlgorithm, SpecialistRole
