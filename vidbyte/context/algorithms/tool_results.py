...
class ContextWindowAlgorithm:
    ...
    def __post_init__(self) -> None:
        ...
        active = [x for x in (self.reflexion, self.multi_provider_agentic_grader, self.parallel_panel, self.trajectory_checkpoints, self.problem_space_search, self.error_correction) if x is not None]
        if len(active) > 1:
