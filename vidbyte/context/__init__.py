...
Relation to codebase as a whole:
    Provides public exports for all context primitives and algorithms (including IndependentCriticAlgorithm, MultiProviderAgenticGraderAlgorithm, and ReflexionAlgorithm) which are consumed by agents and runner engines to manage LLM context windows dynamically.
Similar files:
