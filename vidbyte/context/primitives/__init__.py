...
Architecture:
    ...
    - checkpoints: TrajectoryCheckpointContextItem for trajectory algorithms.
...
from vidbyte.context.primitives.checkpoints import TrajectoryCheckpointContextItem
