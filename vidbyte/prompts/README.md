...
| Jev | `jev` | state_builder, state_builder_multi_part, state_builder_scope_coverage, handoff_builder, handoff_builder_multi_part, handoff_builder_scope_coverage, scope_breadth, scope_unit_coverage, scope_coverage_statement | [jev/](https://github.com/cerredz/Vidbyte-SDK/blob/main/vidbyte/prompts/prompts/jev) |
