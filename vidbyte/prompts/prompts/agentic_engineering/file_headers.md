...
* RELATED DOCS — Links to ADRs, runbooks, design docs, and relevant issues. Each link must include a brief description of what the document explains and when an agent should load it. "ADR-014 — Subscription CQRS split. Load when you need to understand why subscriptions are split into read and write models. ADR-022 — Soft-delete policy for billing entities. Load before implementing any deletion logic."
