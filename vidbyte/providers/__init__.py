...
from vidbyte.providers.compatible import DeepSeekProvider, GLMProvider, KimiProvider, MetaProvider, MiniMaxProvider
...
class ModelProviders:
    ...
    @staticmethod
    def text(config: TextModelConfig) -> OpenAIProvider | AnthropicProvider | GeminiProvider | XAIProvider | DeepSeekProvider | GLMProvider | MiniMaxProvider | KimiProvider | MetaProvider | OpenRouterProvider:
