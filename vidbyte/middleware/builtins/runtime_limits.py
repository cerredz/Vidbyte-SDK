"""
FILE: vidbyte/middleware/builtins/runtime_limits.py

PURPOSE:
    Provides runtime boundary middleware for direct text agent loops. Lets developers abort runs at middleware hook boundaries using elapsed, model-call, or tool-call limits.
...
FUNCTION INVENTORY:
    - RuntimeLimitMiddleware (class): public or navigational symbol owned here.
