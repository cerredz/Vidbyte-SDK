...
PURPOSE:
    Defines concrete deterministic context compaction strategies.
...
FUNCTION INVENTORY:
    - ClearExceptSystemAndLogCompaction (class): public or navigational symbol owned here.
    - RemoveAllToolCallsCompaction (class): public or navigational symbol owned here.
    - RemoveLastNCompaction (class): public or navigational symbol owned here.
    - RemoveToolCallPercentageCompaction (class): public or navigational symbol owned here.
    - KeepLastNMessagesCompaction (class): public or navigational symbol owned here.
    - StripToolResultBodiesCompaction (class): public or navigational symbol owned here.
    - TruncateToolResultMessagesCompaction (class): public or navigational symbol owned here.
    - DeduplicateToolCallsCompaction (class): public or navigational symbol owned here.
    - SummarizeRangeCompaction (class): public or navigational symbol owned here.
    - SummarizeOldestNCompaction (class): public or navigational symbol owned here.
    - SummarizeByTopicBlocksCompaction (class): public or navigational symbol owned here.
    - ReplaceWithTraceCompaction (class): public or navigational symbol owned here.
    - TrimToTokenBudgetCompaction (class): public or navigational symbol owned here.
    - TrimWithProviderBoundariesCompaction (class): public or navigational symbol owned here.
    - DeleteMessagesByIdOrRangeCompaction (class): public or navigational symbol owned here.
    - ToolOutputSlidingWindowCompaction (class): public or navigational symbol owned here.
    - ToolResultClearingWithExclusionsCompaction (class): public or navigational symbol owned here.
    - HeadTailToolPreviewCompaction (class): public or navigational symbol owned here.
    - MechanicalBloatScrubberCompaction (class): public or navigational symbol owned here.
    - SummaryWithBackrefsCompaction (class): public or navigational symbol owned here.
    - SelectiveContextPruningCompaction (class): public or navigational symbol owned here.
    - SalienceScoreEvictionCompaction (class): public or navigational symbol owned here.
    - QueryRelevanceFilterCompaction (class): public or navigational symbol owned here.
    - ContextSnapshotBranchTrimCompaction (class): public or navigational symbol owned here.
    - NoOpCompaction (class): public or navigational symbol owned here.
