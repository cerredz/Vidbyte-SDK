...
PURPOSE:
    Routes compaction modes to strategies and converts between provider and context messages.
...
FUNCTION INVENTORY:
    - ContextCompactionEngine (class): public or navigational symbol owned here.
