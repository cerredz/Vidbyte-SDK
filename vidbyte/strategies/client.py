...
class StrategyClient:
    ...
    def self_refinement(self, *, create_system_prompt: str, refine_system_prompt: str, iterations: int, feedback_system_prompt: str | None = None) -> SelfRefinementStrategy:
        """Create the feedback-and-refinement loop strategy."""
