...
TESTS: This script executes tests/test_jev_agent.py and tests/test_jev_alignment.py and is itself exercised by the source CI script stage.
"""
...
from tests import test_jev_agent, test_jev_alignment
...
def main() -> int:
    ...
    suite = unittest.TestSuite((loader.loadTestsFromModule(test_jev_agent), loader.loadTestsFromModule(test_jev_alignment)))
