...
class Verification:
    ...
    def run():
        ...
        path = Path(__file__).resolve().parents[1] / "tests/codex_observation/test_observation.py"
        spec = importlib.util.spec_from_file_location("codex_observation_tests", path)
